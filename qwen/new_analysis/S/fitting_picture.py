...
# ================= 配置区域 =================
# 拟合生成的参数文件 (根据你的文件名调整)
PARAMS_JSON_PATH = "/home/lsy/match/qwen/new_analysis/unified_params_qwen_en_fitting.json"
...
def main():
    ...
    # 保存图片
    output_img = "/home/lsy/match/qwen/new_analysis/S/sigmoid_verification_plot.png"
