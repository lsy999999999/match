...
def gale_shapley(men_preferences, women_preferences, men_attr, women_attr, output_idx):
    ...
    # --- 文件保存 ---
    output_path = "/home/lsy/match/qwen/0707_qw_eng"
    os.makedirs(output_path, exist_ok=True)
    csv_filename = os.path.join(output_path, f"0707_qw_eng_group{output_idx}.csv")
    json_filename = os.path.join(output_path, f"0707_qw_eng_group{output_idx}.json")
