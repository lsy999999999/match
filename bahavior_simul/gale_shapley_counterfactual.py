...
def gale_shapley(men_preferences, women_preferences, men_attr, women_attr, output_idx):
    ...
    # --- 文件保存 ---
    output_path = "/home/lsy/match/bahavior_simul/0627_gpt4_eng/"
    os.makedirs(output_path, exist_ok=True)
    csv_filename = os.path.join(output_path, f"0618_gpt4_turbo_random_group{output_idx}.csv")
    json_filename = os.path.join(output_path, f"0618_gpt4_turbo_random_group{output_idx}.json")
