...
def gale_shapley(men_preferences, women_preferences, men_attr, women_attr, idx):
    ...
    log_text("/home/lsy/match/bahavior_simul/1011_gpt4_eng/1011_gpt4_eng_group"+str(idx)+".csv", logtext)
    js_obj = json.dumps(matching, ensure_ascii=False, default=default_dump)
    with open("/home/lsy/match/bahavior_simul/1011_gpt4_eng/1011_gpt4_eng_group"+str(idx)+".json", "a") as file:
        file.write(js_obj)
    return matching
