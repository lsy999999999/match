...
class ChineseMatchingAnalyzer:
    ...
    def parse_scores_from_prompt(self, prompt):
        """Extract scores from Chinese prompt"""
        scores = {}
    ...
    def analyze_all_groups(self):
        ...
        print("Analyzing Chinese group data...")
    ...
    def plot_results(self):
        ...
        plt.tight_layout()
        output_file = os.path.join(self.output_path, 'chinese_matching_analysis_comparison.png')
    ...
    def save_results(self):
        ...
        # Save to JSON
        json_file = os.path.join(self.output_path, 'chinese_matching_analysis_results.json')
        ...
        csv_file = os.path.join(self.output_path, 'chinese_group_analysis_results.csv')
    ...
    def print_summary(self):
        ...
        print("\n" + "="*60)
        print("Chinese Group Matching Analysis Summary")
        print("="*60)
...
# Total samples: 1693
#   - Single decisions: 230
#   - Switch partner decisions: 1463

# Overall Parameters:
#   - Single acceptance threshold S = 4.314
#   - Switch partner λ (exponential) = 0.500
#   - Switch partner λ (sigmoid) = 0.050

# Model Accuracy:
#   - Single model: 91.7%
#   - Switch model (exponential): 51.6%
#   - Switch model (sigmoid): 51.8%

# Acceptance Probability Functions:
#   - Single: P(accept) = 1 if Score >= 4.314, else 0
#   - Switch (Exponential): P(accept) = min(1, exp(0.500 * |S_a - S_b|))
#   - Switch (Sigmoid): P(accept) = 1 / (1 + exp(-0.050 * |S_a - S_b|))
