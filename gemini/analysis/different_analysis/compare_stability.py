...
if __name__ == '__main__':
    ...
    beta0_en, lambda_en, s0_en = get_unified_model_params('gemini_en_fitting')
    beta0_zh, lambda_zh, s0_zh = get_unified_model_params('gemini_zh_fitting')
    ...
    gpt4_en_matchings_run = load_matchings_from_json('gemini_en_fitting')
    gpt4_zh_matchings_run = load_matchings_from_json('gemini_zh_fitting')
