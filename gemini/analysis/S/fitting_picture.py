...
# ================= 配置区域 =================
# 拟合生成的参数文件 (根据你的文件名调整)
PARAMS_JSON_PATH = "/home/lsy/match/gemini/analysis/unified_params_gemini_zh_fitting.json"

# 原始决策数据目录 (即 csv 所在文件夹)
# 根据你提供的文件名推测
DECISION_DIR = "/home/lsy/match/gemini/0728_gemini_Chinese" 
# ===========================================
...
def main():
    ...
    # 保存图片
    output_img = "/home/lsy/match/gemini/analysis/S/sigmoid_verification_plot_zh.png"
