...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/lsy/match/.py312/include -fdebug-prefix-map=/croot/tk_1748849386456/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/home/lsy/match/.py312=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/lsy/match/.py312/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/lsy/match/.py312/lib -Wl,-rpath-link,/home/lsy/match/.py312/lib -L/home/lsy/match/.py312/lib -Wl,--export-dynamic '
