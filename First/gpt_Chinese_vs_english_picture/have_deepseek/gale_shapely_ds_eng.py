from read_file_random import *
from ask_deepseek_eng import *
import csv
import json
import datetime
import numpy as np
...
def gale_shapley(men_preferences, women_preferences, men_attr, women_attr, idx):
    ...
    log_text("/home/lsy/match/have_deepseek/0620_deepseek_eng/0620_deepseek_ai_DeepSeek-R1-0528_res"+str(idx)+".csv", logtext)
    js_obj = json.dumps(matching, ensure_ascii=False, default=default_dump)
    with open("/home/lsy/match/have_deepseek/0620_deepseek_eng/0620_deepseek_ai_DeepSeek-R1-0528_res"+str(idx)+".json", "a") as file:
        file.write(js_obj)
    return matching
