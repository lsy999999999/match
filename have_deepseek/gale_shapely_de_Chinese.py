...
from ask_deepseek_Chinese import (
...
def gale_shapley(men_preferences, women_preferences, men_attr, women_attr, idx):
    ...
    log_text("/home/lsy/match/have_deepseek/0620_deepseek_Chinese/0620_deepseek-ai_DeepSeek-R1-0528_Chinese_res"+str(idx)+".csv", logtext)
    js_obj = json.dumps(matching, ensure_ascii=False, default=default_dump)
    with open("/home/lsy/match/have_deepseek/0620_deepseek_Chinese/0620_deepseek-ai_DeepSeek-R1-0528_Chinese_res"+str(idx)+".json", "a") as file:
        file.write(js_obj)
    return matching
